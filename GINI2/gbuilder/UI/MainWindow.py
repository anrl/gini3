...
class MainWindow(Systray):
    ...
    def closeTopology(self):
        ...
        if scene and scene.items():
            reply = QtGui.QMessageBox.warning(self, self.tr("gbuilder"), self.tr("Save before closing?"), QtGui.QMessageBox.Yes | QtGui.QMessageBox.No | QtGui.QMessageBox.Cancel)
    ...
    def startServer(self):
        ...
        if environ["os"] == "Windows":
            ...
            command += "xterm -e " + base + tunnel + " \" " + server + "\""
    ...
    def about(self):
        ...
        """
        QtGui.QMessageBox.about(self, self.tr("About gbuilder 2.0"),
            self.tr("<b>gbuilder 2.0</b>"))
    ...
    def createActions(self):
        ...
        self.sendFileAct = QtGui.QAction(QtGui.QIcon(environ["images"] + "export.png"), self.tr("&Send File..."), self)
    ...
    def createDockWindows(self):
        ...
        self.log.append("Welcome to gbuilder 2.0!\n")
