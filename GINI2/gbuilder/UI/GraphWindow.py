...
class GraphWindow(Dockable):
    def __init__(self, name, parent = None):
        ...
        self.lastIndex = 0
        self.outputQueue = RouterQueue()
        self.defaultQueue = RouterQueue()
        self.queues = {"outputQueue":self.outputQueue,
                       "default":self.defaultQueue
                       }
    ...
    def on_draw(self):
        ...
        x,y = self.smooth(self.outputQueue.getX(), self.outputQueue.getSizes())
        x2,y2 = self.smooth(self.outputQueue.getX(), self.outputQueue.getRates())
        
        self.axesList[0].plot(
            x,
            y,
            antialiased=True,
            lw=3)
        ...
        x,y = self.smooth(self.defaultQueue.getX(), self.defaultQueue.getSizes())
        x2,y2 = self.smooth(self.defaultQueue.getX(), self.defaultQueue.getRates())

        self.axesList[1].plot(
            x,
            y,
            antialiased=True,
            lw=3)
        ...
        """
        self.axesList[2].plot(
            x2,
            y2,
            antialiased=True,
            lw=3)

        self.axesList[3].plot(
            x2,
            y2,
            antialiased=True,
            lw=3)
    ...
    def create_main_frame(self):
        ...
        for w in [self.grid_cb, self.smooth_button]:
            hbox.addWidget(w)
