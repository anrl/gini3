...
typedef enum ofp_error_type             openflow_error_type;
typedef enum ofp_flow_mod_failed_code   openflow_flowtable_modify_failed_code;
...
openflow_error_type flowtable_modify(openflow_flowtable_modify_info* mod);
