...
#define USAGE_FLOWTABLE     "flowtable action [action specific options]"
...
#define SHELP_FLOWTABLE     "create, delete, and view OpenFlow flowtable entries"
...
#define LHELP_FLOWTABLE     "flowtable.hlp"
